...
# https://veronicageek.com/office-365/sharepoint-online/find-checked-out-files-across-multiple-site-collections-and-libraries-in-spo-using-powershell-pnp/2020/02/?utm_source=rss&utm_medium=rss&utm_campaign=find-checked-out-files-across-multiple-site-collections-and-libraries-in-spo-using-powershell-pnp
