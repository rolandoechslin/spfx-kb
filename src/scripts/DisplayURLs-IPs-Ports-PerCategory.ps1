...
# Source: https://github.com/microsoft/Office365NetworkTools/blob/master/Scripts/Display%20URL-IPs-Ports%20per%20Category/DisplayURLs-IPs-Ports-PerCategory.ps1
