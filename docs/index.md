...
- [react-roomchat - Azure Communications Services](https://github.com/pnp/sp-dev-fx-webparts/tree/main/samples/react-roomchat)
...
- [Exposing business data in Microsoft 365 using Azure Data API builder](https://github.com/pnp/sp-dev-fx-aces/tree/main/scenarios/ace-data-api-builder/)
- [ace-expense-report](https://github.com/pnp/spfx-reference-scenarios/tree/main/samples/ace-expense-report)
...
- [microsoft-changelog](https://petri.com/microsoft-changelog/?impact=major-update)
